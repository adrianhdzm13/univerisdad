...
//para mostrar el nombre del usuario al hacer el loguin
...
$row = $resultado->fetch_assoc(); // seria como un arreglo asociativo en cual vamos a realizar toda la informacion
//realizar el recorrido de la tabla 
