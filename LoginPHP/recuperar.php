...
session_start();
//PASAMOS LO QUE ESTA EN L URL CORREO
if(isset($_GET['correo']) && !empty($_GET['correo'])  AND isset($_GET['token']) && !empty($_GET['token'])){
  ...
  $token = mysqli_real_escape_string($conexion,$_GET['token']); //asignamos el parametro de la variable global
  ...
  if ($resultado === 0){
    echo "<script>
        alert('Has ingresado una URL invalida para cambiar la contraseña');
          ...
          <div class="login-container">
            <div class="center">
              <h1>
                ...
                <span class="red">Recuperar </span>
                <span  class="red" id="id-text2">Contraseña</span>
              </h1>
                      ...
                      <fieldset>
                        ...
                        <label class="block clearfix">
                          <span class="block input-icon input-icon-right">
                            <input type="password" name="nuevopass" class="form-control" placeholder="Nueva Contraseña" required />
                            <i class="ace-icon fa fa-lock"></i>
                          </span>
                        </label>
                        <label class="block clearfix">
                          <span class="block input-icon input-icon-right">
                            <input type="password" name="confirmarpass" class="form-control" placeholder=" Confirma tu Contraseña" required />
                            <i class="ace-icon fa fa-lock"></i>
                          </span>
                        </label>
